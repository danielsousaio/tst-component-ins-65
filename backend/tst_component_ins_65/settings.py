"""
Django settings for tst_component_ins_65 project.
...
ROOT_URLCONF = 'tst_component_ins_65.urls'
...
WSGI_APPLICATION = 'tst_component_ins_65.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tst_component_ins_65 API",
    "DESCRIPTION": "API documentation for tst_component_ins_65 App",
    "VERSION": "v1",
}
